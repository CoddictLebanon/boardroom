...
export declare class DocumentsController {
    ...
    constructor(documentsService: DocumentsService, storageService: StorageService);
    ...
    updateFolder(id: string, dto: UpdateFolderDto, companyId: string): Promise<{
        parent: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
    ...
    createDocument(companyId: string, dto: CreateDocumentDto, uploaderId: string, file: Express.Multer.File): Promise<({
        folder: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
    ...
    removeTag(id: string, tag: string, companyId: string): Promise<({
        tags: {
            id: string;
            documentId: string;
            tag: string;
    ...
    downloadFile(path: string[], res: Response): void;
}
