...
export declare class ActionItemsService {
    ...
    create(companyId: string, dto: CreateActionItemDto, userId: string): Promise<{
        company: {
            id: string;
            name: string;
        };
    ...
    findAll(companyId: string, userId: string, filters?: {
        status?: ActionStatus;
        assigneeId?: string;
        priority?: Priority;
        dueDateFrom?: string;
    ...
    update(id: string, dto: UpdateActionItemDto, userId: string): Promise<{
        company: {
            id: string;
            name: string;
        };
    ...
    updateStatus(id: string, dto: UpdateActionItemStatusDto, userId: string): Promise<{
        company: {
            id: string;
            name: string;
        };
    ...
    private checkAndUpdateOverdue;
    private updateOverdueItems;
