...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Email address to invite' }),
    (0, class_validator_1.IsEmail)(),
    __metadata("design:type", String)
], CreateInvitationDto.prototype, "email", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: client_1.MemberRole, description: 'Role for the invited user' }),
    (0, class_validator_1.IsEnum)(client_1.MemberRole),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateInvitationDto.prototype, "role", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Title for the invited user' }),
